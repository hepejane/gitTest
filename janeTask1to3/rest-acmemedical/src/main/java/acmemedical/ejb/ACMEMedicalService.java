    ...
    public void deletePhysicianById(int id) {
        ...
        if (physician != null) {
            ...
            /* TODO ACMECS02 - Use NamedQuery on SecurityRole to find this related Student
               ...
               is not dangling
            */ 
            em.createNamedQuery("SecurityUser.findByPhysicianId", SecurityUser.class);
            findUser.setParameter("physicianId", id);  // Pass physician id as parameter

            // Get the associated SecurityUser
            SecurityUser sUser = findUser.getSingleResult();
            
            // Remove the SecurityUser and Physician
            em.remove(sUser);
            em.remove(physician);
        }
    }
